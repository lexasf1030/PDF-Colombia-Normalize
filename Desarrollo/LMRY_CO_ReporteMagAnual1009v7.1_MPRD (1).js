            ...
            for (var i = 0; i < ctasXPagarArray.length; i++) {
                ...
                if (Number(Math.abs(ctasXPagarArray[i][13]).toFixed(2)) > 0) {
                    ...
                    if (ctasXPagarArray[i][9]) {
                        xmlString += '<saldoscp sal="' + Number(ctasXPagarArray[i][13]).toFixed(0) + '" pais="' + val12 + '" mun="' + val11 + '" dpto="' + val10 + '" dir="' + xml.escape(ctasXPagarArray[i][9].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '<saldoscp sal="' + Number(ctasXPagarArray[i][13]).toFixed(0) + '" pais="' + val12 + '" mun="' + val11 + '" dpto="' + val10 + '" dir="' + '';
                    }

                    if (ctasXPagarArray[i][7]) {
                        xmlString += '" nom2="' + xml.escape(ctasXPagarArray[i][7].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '" nom2="';
                    }

                    if (ctasXPagarArray[i][6]) {
                        xmlString += '" nom1="' + xml.escape(ctasXPagarArray[i][6].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '" nom1="';
                    }

                    if (ctasXPagarArray[i][5]) {
                        xmlString += '" apl2="' + xml.escape(ctasXPagarArray[i][5].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '" apl2="';
                    }

                    if (ctasXPagarArray[i][4]) {
                        xmlString += '" apl1="' + xml.escape(ctasXPagarArray[i][4].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '" apl1="';
                    ...
                    if (ctasXPagarArray[i][8]) {
                        xmlString += '" raz="' + xml.escape(ctasXPagarArray[i][8].replace(/&/g, '&amp;'));
                    } else {
                        xmlString += '" raz="';
