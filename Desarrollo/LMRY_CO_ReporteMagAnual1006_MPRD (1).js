        ...
        function GenerarXml(arr) {
            ...
            for (var i = 0; i < ArrLibroMag.length; i++) {
                ...
                if (impGen > 0 || ivaRecup > 0 || impComs > 0) {
                    ...
                    if (ArrLibroMag[i][7] != '' && ArrLibroMag[i][7] != null && ArrLibroMag[i][7] != '- None -') {
                        strXmlVentasXPagar += '" raz="' + xml.escape(ArrLibroMag[i][7]) + '" nid="' + xml.escape(ArrLibroMag[i][1]) + '" tdoc="' + xml.escape(ArrLibroMag[i][0]);

                        if (ArrLibroMag[i][2] != '' && ArrLibroMag[i][2] != null && ArrLibroMag[i][2] != '- None -') {
                            strXmlVentasXPagar += '" dv="' + xml.escape(ArrLibroMag[i][2]);
                        }

                    } else {
                        strXmlVentasXPagar += '" nid="' + xml.escape(ArrLibroMag[i][1]) + '" tdoc="' + xml.escape(ArrLibroMag[i][0]);

                        if (ArrLibroMag[i][5].split(' ')[0] != null && ArrLibroMag[i][5].split(' ')[0] != '') {
                            strXmlVentasXPagar += '" nom1="' + xml.escape(ArrLibroMag[i][5].split(' ')[0]);

                            if (ArrLibroMag[i][5].split(' ')[1] != null && ArrLibroMag[i][5].split(' ')[1] != '') {
                                strXmlVentasXPagar += '" nom2="' + xml.escape(ArrLibroMag[i][5].split(' ')[1]);
                            }
                        }

                        if (ArrLibroMag[i][3].split(' ')[0] != null && ArrLibroMag[i][3].split(' ')[0] != '') {
                            strXmlVentasXPagar += '" apl1="' + xml.escape(ArrLibroMag[i][3].split(' ')[0]);

                            if (ArrLibroMag[i][3].split(' ')[1] != null && ArrLibroMag[i][3].split(' ')[1] != '') {
                                strXmlVentasXPagar += '" apl2="' + xml.escape(ArrLibroMag[i][3].split(' ')[1]);
                            }
                        }
                    }
