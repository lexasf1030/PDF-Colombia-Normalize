...
define(['N/record', 'N/runtime', 'N/file', 'N/search', 'N/encode',
    ...
    function(record, runtime, file, search, encode, format, log, config, libreria, libReport) {
        ...
        function generateExcel(objResult, shippingNumber) {
            ...
            */
            ...
            for (var i = 0; i < objResult.length; i++) {
                ...
                if (objResult[i][11] != '169') { // Codigo que pertenece a CO
                    //8.  Dirección
        ...
        function getDatePeriod(_paramPeriod, _featCalendar, _paramSubsidiary) {
            ...
            var accountingPeriodSearch = search.create({
                ...
                filters: [
                    ...
                    ["isinactive", "is", "F"],
                    "AND",
                    ["formulatext: {periodname}", "contains", _paramPeriod]
                ],
                columns: [
        ...
        function getArrayPeriods(_paramPeriod, _paramSubsidiary) {
            ...
            log.error('Feature Special Accounting Period', featureSpecialPeriod);
