  ...
  function(recordModulo, runtime, fileModulo, email, search, log,
    ...
    function LlamarMapReduce() {
      try {
        ...
        params['custscript_lmry_terceros_mprdc_opbalance'] = paramOpenBalance;
        params['custscript_lmry_terceros_mprdc_8d'] = paramPuc8D;
    ...
    function ObtenerParametros() {
      ...
      paramOpenBalance = objContext.getParameter({
        name: 'custscript_lmry_co_terce_schdl_opbalance'
      });
      paramPuc8D = objContext.getParameter({
        name: 'custscript_lmry_co_terce_schdl_8d'
      });
      log.debug('parametros:', paramStep + '-' + paramLastPuc + '-' + paramFileID + '-' + paramPuc8D);
